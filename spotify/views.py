...
class CurrentSong(APIView):
    ...
    def update_room_song(self, room, song_id):
        ...
        if current_song != song_id:
            ...
            votes = Vote.objects.filter(room=room).delete() #remove all of the votes of the previous song
...
class PauseSong(APIView):
    def put(self, response, format=None):
        ...
        # Check 1) whether or not the guest allowed to play or pause
        #       2) the user is the host
...
class SkipSong(APIView):
    def post(self, request, format=None):
        ...
        # Check if the user is the host or the votes >= number of votes needed to skip song
